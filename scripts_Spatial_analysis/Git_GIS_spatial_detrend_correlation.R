...
########################################################################################################
#The TRENDY detrended outputs were extracted to global forest areas using GLC2000 mask for Extended Data Fig.1. The detrended outputs were further extracted to North America forest areas for Fig.1
